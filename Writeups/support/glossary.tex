...
% @Last Modified time: 2020-04-11 03:00:48
...
\definenewglossaryterm{HLS}{High Level Synthesis}{An automated hardware design process that takes software written in high-level languages (often C, C++) that algorithmically defines a function, and converts that into an \gls{HDL} that implements that function}
...
\definenewglossaryterm{}{real-time}{Describes a system in which input data is processed in such a time period such that it is available almost immediately. Systems such as missile guidance or collision avoidance in cars are an example of real-time systems}
