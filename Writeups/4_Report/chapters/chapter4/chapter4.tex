...
% @Last Modified time: 2020-04-10 17:58:06
...
\section{Computer Architecture Background}
    \input{chapters/chapter4/architecture_background}

\newpage
\section{RISC-V Instruction Set}
    \input{chapters/chapter4/riscv}

\newpage
\section{Defining a RISC-V Custom Extension}
    \input{chapters/chapter4/extending.tex}

\newpage
\section{PhilosophyV}
    \input{chapters/chapter4/philv}