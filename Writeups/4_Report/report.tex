...
% @Last Modified time: 2020-04-10 12:20:37
...
% DEFINE COVER PAGE
\title{\textsc{\Huge{if goingToCrash: dont}\ \\ \Large{RISC-V Architecture for Motion Planning Algorithms in Autonomous UAVs}} \\ 
    \bigskip
...
\addcontentsline{toc}{chapter}{Preface}
    ...
    \input{abstract}
    \todo[inline]{Abstract still needs some work}
