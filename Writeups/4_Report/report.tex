...
% @Last Modified time: 2020-02-20 00:47:40

\documentclass[11pt, letterpaper, draft, oneside]{report}      % use "amsart" instead of "article" for AMSLaTeX format
...
% ACRONYMNS
% \addcontentsline{toc}{section}{List of Acronymns}
