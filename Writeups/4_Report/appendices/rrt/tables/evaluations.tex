...
% @Last Modified time: 2020-04-06 15:26:04
...
\hline
\end{tabular}
\mycaption{Evaluation of Existing Open-Source Implementations of RRT}{. Links to Github repositories can be found in the Bibliography.}
\end{centering}
\end{table}